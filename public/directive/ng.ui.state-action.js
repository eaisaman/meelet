define(
    ...
    function () {
        return function (appModule, extension, opts) {
            ...
            appModule.directive("uiStateAction", _.union(inject, [function ($rootScope, $http, $parse, $timeout, $interval, $q, $exceptionHandler, angularEventTypes, angularConstants, utilService, uiService, uiCanvasService, appService, serviceRegistry) {
                'use strict';
