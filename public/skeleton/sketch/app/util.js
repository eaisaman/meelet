define(
    ...
    function () {
        return function (appModule, meta) {
            ...
            utilService.prototype.gotoPage = function (currentLocation, pageNum) {
                var self = this,
                    locationIndex,
                    $container = $("#main");
            ...
            utilService.prototype.exitPage = function (currentLocation) {
                if (currentLocation === this.meta.locations[0]) {
                    return this.appService.exitPage();
                } else {
                    return this.firstPage(currentLocation);
                }
            }
