...
requirejs(["angular-lib", "angular-modules-lib", "hammer-lib", "jquery-lib", "underscore-lib", "modernizr-lib", "string-lib", "velocity-lib", "fabric-lib", "chart-lib", "edge-lib"], function () {
    if (isBrowser) {
