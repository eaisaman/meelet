...
requirejs(["jquery-lib", "jquery-plugins-lib", "hammer-lib", "jquery-ui-lib", "jquery-ui-plugins-lib", "angular-lib", "angular-modules-lib", "underscore-lib", "classie-lib", "modernizr-lib", "string-lib", "editormd-lib", "velocity-lib", "wavesurfer-lib", "fabric-lib", "chart-lib", "edge-lib"], function () {
    if (isBrowser) {
