requirejs.config(
    {
        paths: {
            ...
            "app-service-book": APP_COMMON_LIB_PATH + "browser/service.book",
            "embedded-app-service": APP_COMMON_LIB_PATH + "embedded/service",
            "embedded-app-service-book": APP_COMMON_LIB_PATH + "embedded/service.book",
...
define(
    ["json!meta.json", "json!" + APP_COMMON_LIB_PATH + "registry.json", "app-service-registry", "app-util", "app-route", "app-extension", "app-service", "app-service-book", "embedded-app-service", "embedded-app-service-book"],
